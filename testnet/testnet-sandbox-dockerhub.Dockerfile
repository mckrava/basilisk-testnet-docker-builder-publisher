...
ENV VERSION_POLKADOT_NODE=$POLKADOT_NODE
ENV VERSION_BASILISK_NODE=$BASILISK_NODE

RUN echo "VERSION_POLKADOT_NODE - $VERSION_POLKADOT_NODE"
RUN echo "VERSION_BASILISK_NODE - $VERSION_BASILISK_NODE"
